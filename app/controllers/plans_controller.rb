...
class PlansController < ApplicationController
  ...
  def index
    ...
    @plan_invitations = current_user.plan_instance_users.joins(:plan_instance).where(approved: false, removed: false, plan_instance: { deleted: false }).order(created_at: :desc)
